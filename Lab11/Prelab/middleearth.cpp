 ...
 * This class creates the cities, maps and distances between the cities in middle earth 
 ...
 * Sets up randmon number seed 
 * Count number of cities in the array 
 * Select number of cities names of the cities that will be used 
 * Compute random city positions
 * Compute 2-D distance array 
 * Create hash of indices 
 * 
 * @param xsize x-axis size of Middle Earth 
 * @param ysize y-axis size of Middle Earth 
 * @param num_cities number of Middle Earth cities 
 ...
 * @details calls delete on array of distances 
 *
 */
...
/** @brief finds distance between two passed cities 
 *
 * @param city1 first city 
 * @param city2 second city 
 *
 * @return distances between two city parameters in form of a float 
 */
 ...
 * @details The first city is the original start pt as well as the end pt.  
 * 
 * @param length 
 * @if length > cities.size()
 * you cannot ask for an itinerary of more than length, exit. 
 * @else vector<string> itinerary 
 * shuffle cities, erase unneeded ones
 * @endif 
 * @return vector with city names 
 */
